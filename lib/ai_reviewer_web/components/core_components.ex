defmodule AiReviewerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AiReviewerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AiReviewerWeb.Gettext, "errors", msg, opts)
    end
  end
